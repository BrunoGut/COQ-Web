const ESTETICA = [
    {
        id: 1,
        titulo: "¿QUE SON LOS PROCEDIMIENTOS MINIMAMENTE INVASIVOS?",
        descripcion: (
            <p>
    ...
    },
    {
        ...
        descripcion: (
            <p>
                Incluye al conjunto de procedimientos tendientes a activar biológicamente las funciones anabólicas del fibroblasto:
            </p>
        )
    },
    {
    ...
    },
    {
        ...
        descripcion: (
            <p>
                ...
                Presentan pequeñas espículas helicoidales, en dirección ascendente y descendente, de tal manera que una vez implantados se fijan al tejido no permitiendo su desplazamiento.
            </p>
        )
    },
    {

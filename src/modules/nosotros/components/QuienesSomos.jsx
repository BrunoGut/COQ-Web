      ...
      <section className="qs__info" id="quienes-somos">
        <div className="qs__inner">
          ...
          <div className="qs__bloque">
            <h2 className="qs__bloque-titulo">Trayectoria y compromiso</h2>
          ...
          <div className="qs__bloque">
            <h2 className="qs__bloque-titulo">Liderazgo en microcirugía y alta complejidad</h2>
            <p className="qs__bloque-texto">
              Como <strong>centro líder en microcirugía y tecnología láser</strong>, contamos con una
          ...
          <div className="qs__bloque">
            <h2 className="qs__bloque-titulo">Excelencia académica y formación contínua</h2>
            <p className="qs__bloque-texto">
          ...
          <div className="qs__bloque">
            <h2 className="qs__bloque-titulo">Garantía y habilitaciones</h2>
            <p className="qs__bloque-texto">
      ...
      <section className="qs__mapa-section" id="donde-estamos">
        <div className="qs__mapa-card">
          <div className="qs__mapa-grid">
            <h2 className="qs__mapa-titulo">Ubicación</h2>

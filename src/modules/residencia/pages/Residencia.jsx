...
import RankingColegioComponent from "../components/RankingColegioComponent";
import residencia1Img from "../../../assets/images/banner-residencia1.png";
import residencia2Img from "../../../assets/images/banner-residencia2.png";
import residenciaMobile from "../../../assets/images/banner-residencia-mobile.png";
import ringresoResidenciaMobile from "../../../assets/images/banner-ingreso-residencia-mobile.png";
...
function Residencia() {
  return (
    <>
      ...
      <section className="rankingColegio__hero" id="ranking-colegio">
        <h2 className="rankingColegio__banner-titulo">RANKING<br />EXAMEN DEL <br /> COLEGIO MÉDICO</h2>
      </section>
      <RankingColegioComponent />
    </>
  );
}
